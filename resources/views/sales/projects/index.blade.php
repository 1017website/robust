...
<div class="card-r">
    ...
    <div class="table-wrap">
        <table class="table-r">
            <thead><tr><th>Kode</th><th>Project</th><th>Customer</th>@if($showPrices)<th>Nilai</th>@endif<th>Target</th><th>Progress</th><th>Status</th><th></th></tr></thead>
            <tbody>
            @forelse($projects as $p)
                <tr>
                    ...
                    @if($showPrices)<td class="fw-num">{{ \App\Support\Format::rupiahShort($p->total_value) }}</td>@endif
