...
<div class="card-r">
    ...
    <form method="POST" action="{{ route('admin.item-masters.store') }}" class="row g-2 align-items-end">@csrf
        ...
        <div class="col-12"><label class="form-label small">Spesifikasi Default</label><textarea name="specification" rows="6" class="form-control" placeholder="[General]&#10;Type: WB-2005&#10;Manufacturer: PT. Robust Multilab Solusindo&#10;[Dimensions (W x D x H, mm)]&#10;Overall Dimension: 2000 x 750 x 850"></textarea><small class="text-muted-2">Gunakan <code>[Nama Bagian]</code> untuk judul bagian dan <code>Label: Nilai</code> untuk detail export Excel.</small></div>
    </form>
</div>
<div class="card-r">
