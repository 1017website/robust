...
Route::middleware('auth')->group(function () {
    ...
    // ---------- Shared (sales + admin) ----------
    Route::middleware('role:administrator,sales_admin,sales,sales_spv,administration')->group(function () {
    ...
    Route::middleware('role:administrator,sales_admin,sales_spv')->prefix('admin')->name('admin.')->group(function () {
    ...
    // sebagai superadmin; Sales tidak mengelola data teknis/HPP.
    ...
    // kepemilikan lead antar sales oleh Administrator, Sales Admin, dan SPV Sales.
    Route::middleware('role:administrator,sales_admin,sales_spv')->prefix('admin')->name('admin.')->group(function () {
