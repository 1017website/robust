...
class QuotationController extends Controller
{
    ...
    public function markWon(Request $request, Quotation $quotation)
    {
        ...
        return back()->with('success', 'Penawaran ditandai customer setuju. Project sudah dapat dibuat.');
    }
    ...
    protected function validatedData(Request $request, ?Quotation $quotation = null): array
    {
        ...
        return $request->validate([
            ...
            'quotation_file' => [
                ...
                'nullable', 'file', 'mimes:pdf,xls,xlsx,csv,doc,docx,jpg,jpeg,png',
            ],
            'internal_note' => ['nullable', 'string', 'max:1000'],
            'customer_note' => ['nullable', 'string', 'max:500'],
            'documents' => ['nullable', 'array'],
            'documents.*' => ['file', 'mimes:pdf,doc,docx,xls,xlsx,jpg,jpeg,png'],
