...
class Format
{
    ...
    public static function badgeClass(string $status): string
    {
        return match (strtolower($status)) {
            ...
            'accepted', 'approved', 'ready', 'completed', 'selesai', 'won', 'won_closing', 'won / closing', 'customer_accepted', 'request_po_created', 'po_created', 'aktif', 'paid', 'follow_up', 'production_finished' => 'success',
